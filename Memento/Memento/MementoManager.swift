...
class MementoManager {
    ...
    ///
    /// :returns: The list of icons representing the existing memory palaces.
    ...
    /// :returns: The assigned name of the added memory palace.
    ...
    /// :returns: A tuple (finalised palace name, finalised resource name)
    ...
    /// :returns: The specified memory palace or  nil if the specified memory palace is not found.
    ...
    /// :returns: A list of icons of rooms in the memory palace or nil if the memory palace is not found.
    ...
    /// :returns: The room label for the newly-added room or nil if the memory palace is not found.
    ...
    /// :returns:   A tuple of the room's label and the assigned filename of the given image resource. Returns nil if the memory palace is not found.
    ...
    /// :returns: The memory palace room or nil if the memory palace or the room does not exist.
    ...
    /// :param: palaceName The name of the memory palace the room is in.
    /// :param: roomLabel The label of the target room.
    /// :returns: The view representation of the room or nil if the memory palace room is not found.
    ...
    /// :returns: The file name used to save the new image resource or nil if the memory palace room is not found.
    ...
    /// Removes the specified room from the specified memory palace. Does nothing if either the memory palace or the room is invalid.
    ///
    /// :param: palaceName The name of the memory palace the room is in.
    ...
    /// :returns: The label assigned to the new overlay.
    ...
    /// :returns: The added overlay object or nil if the memory palace room is not found.
    ...
    /// This method fails it room is not found or the placeholder overlaps with an existing placeholder.
    ///
    /// :param palaceName The name of the memory palace the room is in.
    ...
    /// :returns: True if the operation is successful and false if one or both associations do not exist.
    ...
    /// :returns: The memory palace room that comes immediately after the one specified or nil if there is no such room.
    ...
    ///
    /// :returns: A list of existing image resource filenames
